...
from web408.modules.catalog.question_scope_repository import QuestionScopeRepository
...
class CatalogReadService:
    ...
    async def list_subjects(
        ...
        *,
        ...
        """返回全部科目 DTO，默认目录顺序，模拟题统计可选名称顺序。"""
        subjects = await self.category_repository.list_subjects(order_by_name=order_by_name)
        return [
