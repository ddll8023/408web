...
from app.modules.auth.read_service import AuthReadService
from app.modules.exam.models import ExamQuestion
from app.modules.catalog.read_service import CatalogReadService
from app.modules.exam.mapper import to_exam_response
from app.modules.exam.repository import ExamQuery, ExamRepository
...
class ExamCategoryQuestionRead:
    """供统计模块使用的真题只读数据。"""
...
class ExamQueryService:
    ...
    async def get_paginated(self, params: ExamQueryParams) -> PaginatedExamResponse:
        ...
        data_list = await self._to_responses(questions)
