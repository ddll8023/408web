                ...
                <div v-show="jsonImportVisible" :id="jsonImportPanelId" class="mt-3 p-5 bg-white border border-gray-100 rounded-xl shadow-sm">
                  ...
                  <div class="flex items-start gap-3 p-4 mb-4 bg-surface rounded-lg border border-accent/10">
                    ...
                    <div class="text-sm text-ink-soft">
                      ...
                      <a href="#" class="text-accent hover:text-accent-hover ml-2 underline underline-offset-2" @click.prevent="showJsonExample('mock')">查看格式示例</a>
                    </div>
                  </div>
                  <textarea
                    v-model="jsonInput"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="1"
                      step="1"
                      class="w-full px-4 py-2.5 h-[42px] bg-white border border-gray-200 rounded-lg text-gray-700 text-base focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-all duration-200"
